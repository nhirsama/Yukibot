    ...
    async def resolve(
        ...
        *,
        ...
        async with self._locks.setdefault(key, asyncio.Lock()):
            title = _topic_title(
                source_title or self.telegram.chat_title(route.source.chat_id),
...
def _topic_title(value: str, source_chat_id: int) -> str:
    title = value.strip() or f"Channel {source_chat_id}"
